...
const SigninPharm = () =>{
    ...
    const logIn = handleSubmit(async (data) =>{
        ...
        const res = await axios.post("http://localhost:4400/api/pharm/login", { 
            email, password
        })
            ...
            {/* <Wrap> */}
                       <FormHold>
                           ...
                           <Social>
                               ...
                               <H55 to="/Login">Sign in as User</H55>
                               <H55 to="/SigninDoc">Sign in Doctor</H55>
                           </Social>
                       </FormHold>
            {/* </Wrap> */}
            </Wrapper>
