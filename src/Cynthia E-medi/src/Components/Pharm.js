            ...
            <Wrapper>
               ...
               <Wrap2>
                   ...
                   <Form onSubmit={handleSearch}>
                    <input placeholder="Search by Location" value={value} onChange={(e)=> setValue(e.target.value)}/>
                    <Buts type="submit" bc="#009587">Search</Buts>
                    <Buts onClick={()=> handleReset()} bc="grey">Reset</Buts>
                 </Form>
                   <CardHold>
                   <Div>
                       {
                       ...
                       <Div >
                       {/* <div key={props._id}>
                           <Boxer name={props.name} bg={`http://localhost:4400/${props.Avatar}`} but='Get Drugs' spec='Pharmacy' title='customers: ' location={props.Location}/>
                       </div> */}
                           {/* <Boxer name='Levi Eniola' bg='/doc4.jpg' but='Get Drugs' spec='Pharmacy' title='customers: '/>
                           <Boxer bg='/doc4.jpg' name='Bright Kolawole' but='Get Drugs' spec='Pharmacy' title='customers: '/>
                           <Boxer bg='/femdoc.jpg' name='Muna Ekeke' but='Get Drugs' spec='Pharmacy' title='customers: '/>
                           <Boxer bg='skin doc.jpg' name='Precious Onuegbu' but='Get Drugs' spec='Pharmacy' title='customers: '/> */}
                          
                           
                       </Div>
                       <div><Button2 to='/allspecialist'>View All Pharmacists</Button2></div>
                   </CardHold>
               </Wrap2>
               <Wrap>
                   <Texts>
                       ...
                       <span style={{
                           ...
                           color:"#888F94",
                           fontSize:"20px"
                       }}>The structure of the pharmaceutical center includes an outpatient department, the department of functional studies of the Nervous system and the Visual Diagnostics and rehabilitation Department. Medical Center provides diagnosis and treatments for patients of all ages.</span>
                       </div>
                   </Texts>
                   <ImgHold >
